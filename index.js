...
const displayStr =
    totalGames === 1?
    `A total of $${totalRaised.toLocaleString("en-US")} has been raised for ${totalGames} games. Currently, ${unfundedGames} game remains unfunded. We need your help to fund these amazing games!`
    : `A total of $${totalRaised.toLocaleString("en-US")} has been raised for ${totalGames} games. Currently, ${unfundedGames} games remains unfunded. We need your help to fund these amazing games!`;
...
let topGameNode = document.createElement("h3");
topGameNode.innerText = first.name;
firstGameContainer.appendChild(topGameNode);

// do the same for the runner up item
let runnerUpNode = document.createElement("h3");
runnerUpNode.innerText = second.name;
secondGameContainer.appendChild(runnerUpNode);
